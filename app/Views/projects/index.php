...
<?= $this->include('projects/css/plugins') ?>
<?= $this->endSection() ?>

<?= $this->section('modules_css') ?>
<?= $this->include('projects/css/styles') ?>
<?= $this->endSection() ?>

<?= $this->section('content') ?>
<?= $this->include('projects/breadcrumb') ?>
                        ...
                        <td>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <img alt="Avatar" class="table-avatar" src="<?php echo base_url(); ?>adminLTE/img/avatar.png">
                                </li>
                                <li class="list-inline-item">
                                    <img alt="Avatar" class="table-avatar" src="<?php echo base_url(); ?>adminLTE/img/avatar2.png">
                                </li>
                                <li class="list-inline-item">
                                    <img alt="Avatar" class="table-avatar" src="<?php echo base_url(); ?>adminLTE/img/avatar3.png">
                                </li>
                                <li class="list-inline-item">
                                    <img alt="Avatar" class="table-avatar" src="<?php echo base_url(); ?>adminLTE/img/avatar4.png">
                                </li>
                            </ul>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <img alt="Avatar" class="table-avatar" src="<?php echo base_url(); ?>adminLTE/img/avatar5.png">
                                </li>
                            </ul>
                        </td>
                        <td class="project_progress">
...
<?= $this->include('projects/script/plugins') ?>
<?= $this->endSection() ?>

<?= $this->section('modules_script') ?>
<?= $this->include('projects/script/script') ?>
<?= $this->endSection() ?>