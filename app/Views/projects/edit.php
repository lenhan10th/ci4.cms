...
<?= $this->include('projects/css/plugins_add') ?>
<?= $this->endSection() ?>

<?= $this->section('modules_css') ?>
<?= $this->include('projects/css/styles_add') ?>
<?= $this->endSection() ?>
...
<?= $this->include('projects/script/plugins_add') ?>
<?= $this->endSection() ?>

<?= $this->section('modules_script') ?>
<?= $this->include('projects/script/script_add') ?>
<?= $this->endSection() ?>